...
const account1 = {
  ...
  movementsDates: [
    ...
    '2024-03-19T17:01:17.194Z',
    '2024-03-21T23:36:17.929Z',
    '2024-03-22T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const formatMovementDate = function (date, locale) {
  ...
  const yearsPassed = calcyearsPassed(new Date(), date);
...
const startLogOutTimer = function () {
  ...
  // Call the timer everty second
  tick();
  const timer = setInterval(tick, 1000); // in miliseconds (every second)
  return timer;
};
///////////////////////////////////////
// Event handlers
